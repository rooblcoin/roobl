...
uint256 hashGenesisBlock("0x0f4442659786c21946c0e6046607d305947f8aa408d094685ebfc9bdc9d6bd98");
...
const string strMessageMagic = "rooblcoin Signed Message:\n";
...
{
    int64 nSubsidy = 130 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // rooblcoin: 1 days
static const int64 nTargetSpacing = 120; // rooblcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal rooblcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "rooblcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe2dbea32d70c13c18d8f00a4a06ccbd003f7b27398402cc0e1ff0248c8bbb166");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Elections Of The President Of Russia";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1520532340; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2001442;

        if (fTestNet)
        {
            block.nTime    = 1520528300;
            block.nNonce   = 1879718;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfff4f26ee00570fdcba1e5bbbcbd17cbee80dd82d3417db32a3bf8f5c0c4f1fd"));
